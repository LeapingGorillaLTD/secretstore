...
namespace LeapingGorilla.SecretStore.Tests.EncryptionManagerTests
{
	public abstract class WhenTestingEncryptionManager : WhenTestingTheBehaviourOf
	{
		...
		public void KeyManagerReturnsDataKey()
		{
			...
			KeyManager.DecryptData(Arg.Is(ValidKeyId), Arg.Any<byte[]>()).Returns(dummy.PlainTextKey);
		}
		...
		private GenerateDataKeyResult DummyResult
		{
			get { return JsonConvert.DeserializeObject<GenerateDataKeyResult>(SerialisedDataKeyResult); }
		}
	}
}
